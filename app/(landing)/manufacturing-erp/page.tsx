...
// matching the sibling ERP landing page.
const TEXT = '#F2EEE8'
        ...
        <main style={{ backgroundColor: DARK, color: TEXT, fontFamily: INTER }}>
            ...
            <section data-theme="dark" style={{ padding: isMobile ? '4rem 5% 3rem' : '7rem 8% 5rem' }}>
                <div style={{ maxWidth: '900px' }}>
                    <span style={EYEBROW}>Custom ERP software for manufacturers</span>
                    <h1
                        style={{
                            fontFamily: 'var(--font-montserrat), sans-serif',
                    ...
                    >
                        Custom manufacturing ERP software, built around your factory.
                    </h1>
            ...
            {/* Signals — captures "do I need an ERP yet" research intent */}
            <section data-theme="dark" style={{ padding: pad }}>
                <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
                    <span style={EYEBROW}>Sound familiar?</span>
                    <h2 style={H2}>When a factory has outgrown spreadsheets</h2>
                    <div
                        style={{
                            marginTop: '2.5rem',
                            display: 'grid',
                    ...
                    <p style={{ ...LEAD, marginTop: '2.5rem', maxWidth: '660px', opacity: 0.78 }}>
                        Two of these and the spreadsheets are already costing you more than software would.
                        You just cannot see it on a bill anywhere.
                    </p>
                </div>
            </section>
                ...
                <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
                    ...
                    >
                        <p style={{ ...LEAD, opacity: 0.8, margin: 0 }}>
                            Custom is supposed to be the expensive one. Boxed is supposed to be the safe cheap
                            one. It is usually the other way round, and nobody says so out loud. You pay for the
                            whole bundle — the modules for the plant you do not have, the ones nobody has ever
                            opened — and then you pay for every person who logs in, again next year, and the year
                            after.
                        </p>
                        <p style={{ ...LEAD, opacity: 0.8, margin: 0 }}>
                            We build what your factory uses and stop. Modern tools, small team, no waste. And when
                            the boxed product does not fit your process — it will not, not exactly — you are paying
                            a second time to make it behave. You skip that. You own what we build, you start where
            ...
            <section data-theme="dark" style={{ padding: pad }}>
                <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                    ...
                    <h2 style={H2}>Newer tech. Everywhere your team works.</h2>
                    <p style={{ ...LEAD, marginTop: '1.25rem', maxWidth: '640px', opacity: 0.75 }}>
                        Most ERPs running today were drawn up for a clerk at a desktop in an office. Your plant
                        stopped working like that a long time ago.
                    </p>
            ...
            <section data-theme="light" style={{ backgroundColor: SAND, color: DARK, padding: pad }}>
                <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                    ...
                    <h2 style={H2}>Features a manufacturing ERP actually needs</h2>
                    <p style={{ ...LEAD, marginTop: '1.25rem', maxWidth: '640px', opacity: 0.7 }}>
                        Not a list to impress you. The parts a factory cannot actually run without. You will not
                        need all of them — nobody does — and we would rather leave one out than build a screen
                        your team clicks past every morning.
                    </p>
                    ...
                    >
                        {FEATURES.map((feature, i) => (
                            <div
                                key={feature.title}
                                style={{
                                    borderTop: '1px solid rgba(46,42,38,0.18)',
                                    paddingTop: '1.1rem',
                                }}
                            >
            ...
            {/* Comparison — the decision people are actually making */}
            <section data-theme="dark" style={{ padding: pad }}>
                <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
                    <span style={EYEBROW}>Custom vs off-the-shelf</span>
                    <h2 style={H2}>Custom ERP or a boxed product?</h2>
                    <p style={{ ...LEAD, marginTop: '1.25rem', maxWidth: '660px', opacity: 0.75 }}>
                        Sometimes off-the-shelf is the right call. If your factory already works the way the
                        software expects, buy it, save your money. If not, here is the comparison nobody selling
                        you a licence will run.
                    </p>
                        ...
                        {COMPARISON.map((row) => (
                            ...
                            >
                                ...
                                <span style={{ fontSize: '0.92rem', lineHeight: 1.6, opacity: 0.55 }}>
                                    {isMobile && <strong style={{ opacity: 0.75 }}>Boxed: </strong>}
                                    {row.boxed}
                                </span>
            ...
            {/* Industries + internal link to the Mumbai ERP page */}
            <section data-theme="dark" style={{ backgroundColor: '#25221F', padding: pad }}>
                <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
                    ...
                    <p style={{ ...LEAD, marginTop: '2.75rem', maxWidth: '660px', opacity: 0.8 }}>
                        Based in and around the city? We work on the ground with plants in Thane, Bhiwandi and
                        Navi Mumbai — see{' '}
                        <Link
                            href="/erp-systems-for-manufacturers"
                            style={{ color: SAND, textDecoration: 'underline', textUnderlineOffset: '3px' }}
                        >
                            our ERP software for Mumbai manufacturers
                        </Link>
                        ...
                        {FAQ_ITEMS.map((faq, i) => {
                            ...
                            return (
                                <div key={faq.question} style={{ borderTop: '1px solid rgba(232,223,211,0.14)' }}>
                                    ...
                                    <div
                                        style={{
                                            // Generous cap: the longest answers need ~254px on a
            ...
            <section data-theme="dark" style={{ backgroundColor: '#25221F', padding: pad, textAlign: 'center' }}>
                <div style={{ maxWidth: '720px', margin: '0 auto' }}>
                    ...
                    <p style={{ ...LEAD, marginTop: '1.25rem', opacity: 0.78 }}>
                        Stock that never matches. Jobs that slip. Paperwork nobody has time for and everybody
                        does anyway. Tell us what your factory is fighting with and we will show you what we
