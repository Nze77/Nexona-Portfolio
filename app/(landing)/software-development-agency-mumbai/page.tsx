                ...
                <div style={{ maxWidth: '1400px', margin: '0 auto', display: 'flex', flexDirection: isMobile ? 'column' : 'row', alignItems: 'center', gap: isMobile ? '4rem' : '8rem' }}>
                    ...
                    >
                        ...
                        <motion.p variants={fadeInUp} style={{ fontFamily: INTER, opacity: 0.8, lineHeight: 1.8, fontSize: '1.15rem', marginBottom: '1.5rem' }}>
                            <Link href="/" style={inlineLink}>Nexona</Link> is a software agency in Mumbai that partners with startups, SMEs, and enterprises across India&apos;s financial capital to design, build, and scale custom digital products. Whether you need a full-stack web application, a tailored <Link href="/erp-systems-for-manufacturers" style={inlineLink}>ERP</Link> or <Link href="/customer-retention-management-software" style={inlineLink}>CRM system</Link>, or <Link href="/ai-automation-agency" style={inlineLink}>AI and process automation</Link> to streamline operations, our Mumbai software development team handles the entire journey — from architecture to deployment and support. When the brief is an autonomous system rather than a workflow, that becomes <Link href="/ai-agent-development-company" style={inlineLink}>AI agent development</Link>. And when what you actually need is someone to own the architecture and hiring decisions rather than a build, that is <Link href="/fractional-cto-as-a-service" style={inlineLink}>Fractional CTO as a Service</Link>.
                        </motion.p>
